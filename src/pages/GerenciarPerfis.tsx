      ...
      {loading && <div className="d-flex justify-content-center m-3"><ReactLoading type="spinningBubbles" color="#000000" /></div>}
      {
        ...
        <form className="d-flex flex-column">
          <section className="d-flex align-items-center w-100">
            ...
            <input className="w-100" value={nome} onChange={e => setNome(e.target.value)}/>
          </section>
...
export default function GerenciarPerfis() {
  ...
  const [showPerfil, setShowCreatePerfil] = useState(false);

  return (
    <div className="App">
      <Header />
      <TrilhaDeNavegacao elementosLi={paginas} registrarPerfis mostrarModal={setShowCreatePerfil}></TrilhaDeNavegacao>
